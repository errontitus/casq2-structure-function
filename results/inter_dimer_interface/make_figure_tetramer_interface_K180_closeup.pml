...
# stapled helix: H188, K47 (but side chain not currently resolved, so not sure), P145, R121 (H bond or anion-quadrupole with H188)
...
# sele helix, resi 177-189
# create obj_helix, helix

#sele helix_yb, ((chain U) and resi 1) or ((chain T) and resi 2)
#hide everything, hetatm and not helix_yb
show cartoon, tetramer_yb
show spheres, 184_yb

# sele view_center, helix_yb
# zoom view_center, 9

# cmd.ray(ray_width_closeups(), ray_height_closeups())
# cmd.png("./output/tetramer_deo_yb_interface_K180_etc.png", dpi=dpi())

# sele view_center, (tetramer_yb and chain C and i. 184 and n;OE2)
sele view_center, (chain C and resi 180 and n. NZ) or (chain C and resi 184 and n. OE2) or (184_yb and chain C)
zoom view_center, 5
...
y = 600
cmd.viewport(x, y)
save_image_closeup("tetramer_interface_K180_closeup_yb", x, y)
...
# select anom_site, 184_yb_C
# isomesh map, 6OWW_yb_refined_map_coefficients_anom, 0.5, anom_site, carve=3
# color red, map
bg_color white
